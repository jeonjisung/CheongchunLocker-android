...
public class Locker7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.locker_7);
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if(task.isSuccessful()){
                            for(QueryDocumentSnapshot document : task.getResult()){
                                if(document.getReference().getId().equals("locker7")){
        ...
        storageRef.child("uploads/"+"locker7.png").getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
            public void onSuccess(Uri uri) {

                Glide.with(Locker7.this).load(uri).into(productImg); // Glide를 사용하여 이미지 로드
            }
        ...
        editBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Locker7.this, UploadActivity.class);
                startActivity(intent);
                finish();
                Save_Var.getInstance().now = "locker7";
            }
        });
    }
